...
namespace bitirme_bilgen
{
    public partial class Araclar : Form
    {
        ...
        private void Araclar_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i  < dgvAraclar.Rows.Count ; i++)
{
                this.chart1.Series["Sonuc"].Points.AddXY(dgvAraclar.Rows[i].Cells[0].Value.ToString(), Convert.ToInt32(dgvAraclar.Rows[i].Cells[1].Value.ToString()));
                this.chart1.ChartAreas[0].AxisX.LabelStyle.Angle = -70;
            }
